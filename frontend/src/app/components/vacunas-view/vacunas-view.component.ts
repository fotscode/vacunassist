...
@Component({
  selector: 'app-vacunas-view',
  templateUrl: './vacunas-view.component.html',
  styleUrls: ['./vacunas-view.component.css']
})
export class VacunasViewComponent implements OnInit {
  vacunas = {
    covid: {
      dosis: 0,
      fecha: new Date(),
